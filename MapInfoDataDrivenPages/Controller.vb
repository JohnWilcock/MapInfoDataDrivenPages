...
Namespace MapInfoDataDrivenPages
    Public Class Controller
        ...
        Private Const STR_APP_DOCK_INFO_NODE As String = "MapInfoDataDrivenPagesDockPosInfo"
        '' file with path for docking persistence
        Private sDockInfoXMLFile As String = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MapInfo\\MapInfo\\Professional\\" + InteropHelper.GetAppVersion() + "\\MapInfoDataDrivenPages_dockinfo.xml"

        Private Shared _Dlg As Dlg = Nothing     '' DDP dialog
        ...
        Private Const controllerMutexName As String = "MapInfoDataDrivenPages.MapInfoDataDrivenPagesDockController" '' Name of the mutex
        ...
        ''' <summary>
        ''' This function is called from MapBasic code
        ''' to close the DDP dialog before exiting.
        ''' </summary>
        ...
        ''' <summary>
        ''' Close the dockable usercontrol(DDP Dialog)
        ''' </summary>
        ...
        ''' <summary>
        ''' get the open/close status of dockable user control DDP  dialog)
        ''' </summary>
